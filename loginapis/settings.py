"""
Django settings for loginapis project.
...
SECRET_KEY = 'django-insecure-l+x^ek*ht3&=e76q!hl85b*a$+exjoqx+)o@fi8jduk143f%wk'
...
WSGI_APPLICATION = 'loginapis.wsgi.application'
